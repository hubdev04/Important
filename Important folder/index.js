...
const imagearray=["./flower1.png","./flower2.png","./pinkflower.png"];
var img1=document.querySelector(".sli1 img");
img1.src=imagearray[0];
var img2=document.querySelector(".sli2 img");
img2.src=imagearray[1];
var img3=document.querySelector(".sli3 img");
